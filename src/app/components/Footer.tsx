    ...
    <footer className="appFooter">
      <div className="footerInner">
        <div className="footerBrand">
          <span className="footerLogoDot" />
          <span className="footerBrandName">AIRIS</span>
        </div>

        <div className="footerCredit">
          Built by{" "}
          <span className="footerAuthor">Yash Unhawane</span>
        </div>

        <div className="footerLinks">
          <a
            href="https://github.com/yashunhawane"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/yash-unhawane-085137177/"
            target="_blank"
            rel="noopener noreferrer"
            className="footerLink"
            title="LinkedIn"
